...
Qt5_version="5.15.2"
Qt5_modules="qtbase qtdeclarative qtxmlpatterns qtsvg qtwebp qtmultimedia"

Qt6_version="6.3.0"
Qt6_modules="qtbase qtdeclarative qtsvg qtwebp qtmultimedia qt5compat qtshadertools"
